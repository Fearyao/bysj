...
<div class="indexPage ">
  ...
  <el-row type="flex">
    <el-carousel class="carousel" :interval="4000" type="card" height="200px">
      <el-carousel-item><a href='/#/lifePage'>
        <img src="./img/life.jpg" style='width:100%;height:100%'></a>
      </el-carousel-item>
      <el-carousel-item><a href='/#/artPage'>
        <img src="./img/art.jpg" style='width:100%;height:100%'></a>
      </el-carousel-item>
      <el-carousel-item><a href='/#/gamePage'>
        <img src="./img/game.jpg" style='width:100%;height:100%'></a>
      </el-carousel-item>
      <el-carousel-item><a href='/#/otherPage'>
        <img src="./img/other.jpg" style='width:100%;height:100%'></a>
      </el-carousel-item>
    </el-carousel>
  </el-row>
